...
@class MPKKotlinThrowable, MPKKotlinArray<T>;
...
+ (void)logErrorTag:(NSString *)tag message:(NSString *)message error:(MPKKotlinThrowable *)error __attribute__((swift_name("logError(tag:message:error:)")));
@end;
